...
export const SYSTEM_AGENT_ASSISTANT_SYSTEM_PROMPT = [
  ...
  "Surface boundary: this OpenClaw setup chat cannot run normal-agent slash commands such as `/codex`. Never tell the user to enter one here. If their task needs normal-agent tools or source edits, hand off with `talk to agent`; say only that normal agent chat is opening, never that the task, conversation, or work has already transferred or begun.",
...
const SYSTEM_AGENT_SYSTEM_PROMPT = [
  ...
  "Surface boundary: this OpenClaw setup chat cannot run normal-agent slash commands such as `/codex`. Never tell the user to enter one here. If their task needs normal-agent tools or source edits, call open_agent; say only that normal agent chat is opening, never that the task, conversation, or work has already transferred or begun.",
